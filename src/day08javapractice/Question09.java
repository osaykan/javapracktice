...
public class Question09 {
	 ...
	 * 
	 * 1. Adım : İsim ve telefon numaralarını HashMap ile tutunuz.
	 * 2. Adım : Kullanıcıya 1-Kişi Ekle , 2-Kişi Çıkar, 3-Rehberi Gör, 4-Çıkış seçenekleri sunalım.
	 * 3. Adım : Bu işlem için while döngüsü kullanalım, 
	 * 			    kullanıcı 4- Çıkış'a tıklayana kadar sürekli gösterelim.
	 * 
	...
	public static void main(String[] args) {
		...
		while(!cikis) { // cikis ==  false
			System.out.println("1-Kisi Ekle , 2-Kisi Cikar, 3-Rehberi Gör, 4-Cikis");
